...
import numpy as np
import constants
from utils import convert_meters_to_pixel_distance, convert_pixel_distance_to_meters, get_foot_position\
                , get_closest_keypoint_index, get_height_of_bbox, measure_xy_distance, get_center_box, measure_distance
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        #List of zeros and its going to have 28 zeros
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                if bboxes_heights_in_pixels:
                    ...
                    # fallback: skip or use default value
                ...
                if closest_player_id_to_ball == player_id:
                    # Get the closes keypoint in pixels
